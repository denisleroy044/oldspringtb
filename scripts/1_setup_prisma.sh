...
# Script: 1_setup_prisma.sh
# Description: Setup Prisma with merged schema for Console database
...
if [ ! -f .env ]; then
  echo "Please enter your Console PostgreSQL database URL:"
  read -r db_url
...
echo ""
echo "Next steps:"
echo "1. Update the DATABASE_URL in .env file if needed"
echo "2. Run: npx prisma migrate dev --name init"
echo "3. Run: npx prisma generate"
echo ""
echo "📁 Backup of original schema saved at: prisma/schema.prisma.backup"
EOF