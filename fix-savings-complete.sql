...
-- Insert default savings templates with proper hex colors
...
BEGIN
  ...
  IF demo_user_id IS NOT NULL AND checking_account_id IS NOT NULL THEN
    ...
    -- Insert sample savings with proper hex colors
...
-- Verify the data
SELECT 'Savings templates count: ' as info, COUNT(*) FROM savings_templates;
SELECT 'Savings goals count: ' as info, COUNT(*) FROM savings;
SELECT 'Contributions count: ' as info, COUNT(*) FROM savings_contributions;
