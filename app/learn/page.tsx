...
export default function LearnPage() {
  ...
  const featuredArticles = [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1565514020179-026b92b5e2a3?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div className="relative h-64 md:h-96">
                  <Image
                    src="https://images.unsplash.com/photo-1556740714-a8395b3bf30f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"
