...
BEGIN
  ...
  -- Ensure user_id column references users table
  IF NOT EXISTS (
...
-- Drop and recreate statements table to ensure correct schema
...
-- ============================================
-- CREATE SAMPLE STATEMENTS FOR DEMO USER
-- ============================================
...
-- Show statements table structure
SELECT 
...
SELECT 
  'generate_monthly_statement' as function_name,
  proname as exists 
FROM pg_proc 
WHERE proname = 'generate_monthly_statement';

-- Count statements for demo user
SELECT 
  u.email,
