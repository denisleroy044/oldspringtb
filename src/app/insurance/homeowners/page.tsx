        ...
        <section className="bg-gradient-to-br from-[#1e3a5f] to-[#2E8B57] py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Homeowners Insurance</h1>
                <p className="text-xl text-gray-200 mb-6">
                  Protect your most valuable asset with comprehensive homeowners insurance coverage.
                </p>
                <Link
                  href="/auth/signup"
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[#1e3a5f] mb-4">What's Covered</h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Our homeowners insurance provides comprehensive protection for your home and belongings.
              </p>
            </div>

            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                <h3 className="text-2xl font-bold text-[#1e3a5f] mb-4">Dwelling Coverage</h3>
                <p className="text-gray-600">Protects the structure of your home from covered perils like fire, wind, and hail.</p>
              </div>
              <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                <h3 className="text-2xl font-bold text-[#1e3a5f] mb-4">Personal Property</h3>
                <p className="text-gray-600">Covers your belongings like furniture, electronics, and clothing.</p>
              </div>
              <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                <h3 className="text-2xl font-bold text-[#1e3a5f] mb-4">Liability Protection</h3>
                <p className="text-gray-600">Protects you if someone is injured on your property.</p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-[#1e3a5f] to-[#2E8B57] rounded-2xl shadow-xl p-8 text-white relative overflow-hidden">
              ...
              <div className="relative text-center">
                <h2 className="text-3xl font-bold mb-4">Protect Your Home Sweet Home</h2>
