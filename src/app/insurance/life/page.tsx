        ...
        <section className="bg-gradient-to-br from-[#1e3a5f] to-[#2E8B57] py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Life Insurance</h1>
                <p className="text-xl text-gray-200 mb-6">
                  Protect your loved ones with comprehensive life insurance coverage that provides financial security for their future.
                </p>
                <Link
                  href="/auth/signup"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                We offer flexible life insurance options to meet your unique needs and budget.
              </p>
            </div>

            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                <h3 className="text-2xl font-bold text-[#1e3a5f] mb-4">Term Life Insurance</h3>
                <p className="text-gray-600 mb-4">Affordable coverage for a specific period, perfect for income replacement and mortgage protection.</p>
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                <h3 className="text-2xl font-bold text-[#1e3a5f] mb-4">Whole Life Insurance</h3>
                <p className="text-gray-600 mb-4">Lifetime protection with cash value accumulation for long-term financial security.</p>
                <ul className="space-y-2 text-gray-600">
                  <li className="flex items-center">
                    <svg className="w-5 h-5 text-[#2E8B57] mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
            ...
            <div className="bg-gradient-to-r from-[#1e3a5f] to-[#2E8B57] rounded-2xl shadow-xl p-8 text-white relative overflow-hidden">
              ...
              <div className="relative text-center">
                ...
                <p className="text-lg mb-6 max-w-2xl mx-auto">
                  Get a free life insurance quote today and ensure your loved ones are protected.
                </p>
                <Link
                  href="/auth/signup"
