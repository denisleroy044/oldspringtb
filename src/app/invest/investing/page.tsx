...
export default function OnlineInvestingPage() {
  return (
    <>
      <Header />
        ...
        <section className="bg-gradient-to-br from-[#1e3a5f] to-[#2E8B57] py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Online Investing</h1>
                <p className="text-xl text-gray-200 mb-6">
                  Take control of your investments with our powerful online platform. Trade stocks, ETFs, and more from anywhere.
                </p>
                <Link
                  href="/auth/signup"
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[#1e3a5f] mb-4">Platform Features</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                <h3 className="text-2xl font-bold text-[#1e3a5f] mb-4">Real-Time Trading</h3>
                <p className="text-gray-600">Execute trades instantly with our advanced trading platform.</p>
              </div>
              <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                <h3 className="text-2xl font-bold text-[#1e3a5f] mb-4">Research Tools</h3>
                <p className="text-gray-600">Access comprehensive market data and analysis to make informed decisions.</p>
              </div>
              <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                <h3 className="text-2xl font-bold text-[#1e3a5f] mb-4">Mobile App</h3>
                <p className="text-gray-600">Monitor and manage your portfolio from anywhere with our mobile app.</p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-[#1e3a5f] to-[#2E8B57] rounded-2xl shadow-xl p-8 text-white relative overflow-hidden">
              ...
              <div className="relative text-center">
                ...
                <p className="text-lg mb-6 max-w-2xl mx-auto">
                  Open an account today and start investing in your future.
                </p>
                <Link
                  href="/auth/signup"
