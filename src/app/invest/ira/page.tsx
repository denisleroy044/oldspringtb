        ...
        <section className="bg-gradient-to-br from-[#1e3a5f] to-[#2E8B57] py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">IRA Rollover</h1>
                <p className="text-xl text-gray-200 mb-6">
                  Simplify your retirement savings and take control of your financial future with our IRA rollover solutions.
                </p>
                <Link
                ...
                >
                  ...
                  <span className="relative">Start Rollover</span>
                </Link>
              </div>
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[#1e3a5f] mb-4">Why Roll Over Your IRA?</h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Discover the benefits of consolidating your retirement accounts with Oldspring Trust.
              </p>
            </div>

            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                <h3 className="text-2xl font-bold text-[#1e3a5f] mb-4">More Options</h3>
                <p className="text-gray-600">Access a wider range of investment choices and strategies.</p>
              </div>
              <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                <h3 className="text-2xl font-bold text-[#1e3a5f] mb-4">Lower Fees</h3>
                <p className="text-gray-600">Reduce administrative costs and keep more of your returns.</p>
              </div>
              <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                <h3 className="text-2xl font-bold text-[#1e3a5f] mb-4">Simplified Management</h3>
                <p className="text-gray-600">Track all your retirement savings in one convenient place.</p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-[#1e3a5f] to-[#2E8B57] rounded-2xl shadow-xl p-8 text-white relative overflow-hidden">
              ...
              <div className="relative text-center">
                <h2 className="text-3xl font-bold mb-4">Ready to Consolidate?</h2>
                <p className="text-lg mb-6 max-w-2xl mx-auto">
                  Let our experts guide you through a seamless IRA rollover process.
                </p>
                <Link
                  href="/invest/consultation"
