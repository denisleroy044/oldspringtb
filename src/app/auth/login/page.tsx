        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <ScrollAnimation animation="fadeInLeft" className="hidden lg:block">
              <div className="pr-12">
                {/* Logo - Replaced O with actual logo */}
                ...
                {/* Decorative Elements - Using specified glass images */}
              ...
              <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 md:p-10 border border-white/50">
                ...
                <form className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <button className="flex items-center justify-center gap-3 bg-white border border-gray-200 rounded-xl py-3 px-4 hover:border-soft-gold hover:shadow-md transition-all duration-300 group">
