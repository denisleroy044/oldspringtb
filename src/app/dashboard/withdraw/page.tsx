            ...
            {accounts.length === 0 ? (
              <div className="text-center py-8">
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 bg-deep-teal text-white btn-shimmer btn-shimmer rounded-lg hover:bg-sage"
                >
      ...
      {step === 2 && selectedMethod && (
        <div className="space-y-6">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-deep-teal to-sage btn-shimmer btn-shimmer text-white py-4 rounded-xl font-semibold hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {submitting ? (
              <>
