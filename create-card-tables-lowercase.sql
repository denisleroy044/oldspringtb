-- First, let's check the actual table names from your database
-- From your check, tables are: users, accounts, transactions, etc. (all lowercase)

-- Create cards table (lowercase)
...
-- Create card_requests table (lowercase)
...
BEGIN
  -- Get demo user ID (lowercase table name)
  SELECT id INTO demo_user_id FROM users WHERE email = 'demo@oldspring.com';
  
  IF demo_user_id IS NOT NULL THEN
    -- Get their checking account (lowercase table name)
